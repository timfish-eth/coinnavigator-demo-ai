...
export function WelcomeToast() {
  ...
  return (
    <div
      className={cn(
        "fixed right-4 top-4 z-40 w-[340px] max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-border bg-card shadow-[0_18px_60px_-12px_rgba(0,0,0,0.6)] transition-all duration-300",
