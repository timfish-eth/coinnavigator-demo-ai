  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center">
      ...
      <div
        ...
        className="relative flex w-full flex-col overflow-hidden rounded-t-2xl border border-white/[0.08] bg-[#0B1220] shadow-[0_24px_80px_-12px_rgba(0,0,0,0.7)] modal-panel-enter sm:w-[420px] sm:rounded-2xl"
      >
